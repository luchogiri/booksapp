...
export const Header = (props: Object) => {
  ...
  const like_img = !liked ? require('../../public/img/icon-like.png'):
                      require('../../public/img/icon-liked.png');
  ...
  return (
    <View style={styles.wrapper}>
      ...
      <TouchableOpacity style={styles.button} onPress={search || like}>
        {search && <Image source={require('../../public/img/icon-search.png')} style={styles.icon} />}
        {like && <Image source={like_img} style={styles.icon} />}
      </TouchableOpacity>
    </View>
  );
};
